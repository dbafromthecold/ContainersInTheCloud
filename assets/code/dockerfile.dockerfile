...
CMD /opt/mssql/bin/sqlservr & \ 
	/opt/mssql-tools/bin/sqlcmd -S . -U sa -P $SA_PASSWORD \ 
		-Q "CREATE DATABASE [DatabaseA] ON (FILENAME = '/var/opt/sqlserver/DatabaseA.mdf’), 
				(FILENAME = '/var/opt/sqlserver/DatabaseA_log.ldf') FOR ATTACH" 
